...
> Причем не обязательно, чтобы у модели был производитель. Производители без моделей и типы кузовов без моделей не выведутся, т.к они не соответсвуют прямому соединению inner join public.body b on mdl.body_id = b.id. 
