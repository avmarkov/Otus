...
> Количество контрольных точек получилост 26, но их получилось больше, т.к. выполняются они раз/30сек. Перед запуском pgbench и после тоже каое-то время прошло.
...
> --- Не уверен, что именно здесь их нужно смотреть
